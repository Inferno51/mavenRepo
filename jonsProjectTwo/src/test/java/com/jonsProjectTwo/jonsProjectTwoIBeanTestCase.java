 ...
 */
public class jonsProjectTwoIBeanTestCase extends AbstractMuleTestCase
{
    @IntegrationBean
    private jonsProjectTwoIBean ibean;

    public jonsProjectTwoIBeanTestCase()
    {
